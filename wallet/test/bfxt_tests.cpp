...
#include "bfxt/bfxttokentxdata.h"
#include "bfxt/bfxttransaction.h"
#include "bfxt/bfxttxin.h"
#include "bfxt/bfxttxout.h"
...
TEST(bfxt_tests, parse_BFXTTxIn_from_json)
{
    std::string tx_str =
...
TEST(bfxt_tests, parse_BFXTTxOut_from_json)
{
...
TEST(bfxt_tests, parse_BFXTTransaction)
{
    std::string tx_str =
        "{\"hex\":"
        ...
        "\"confirmations\":26948}";
    BFXTTransaction tx_good, tx_nogood;
    EXPECT_NO_THROW(tx_good.importJsonData(tx_str));
    EXPECT_ANY_THROW(tx_nogood.importJsonData(tx_str.substr(0, tx_str.size() - 1)));
    ...
    EXPECT_EQ(tx_good.getTxOut(0).getType(), BFXTTxOut::OutputType::NormalOutput);
    ...
    EXPECT_EQ(tx_good.getTxOut(1).getType(), BFXTTxOut::OutputType::NormalOutput);
    ...
    EXPECT_EQ(tx_good.getTxOut(2).getType(), BFXTTxOut::OutputType::OPReturn);
...
TEST(bfxt_tests, token_meta_data)
{
    std::string metadata = "{\"tokenId\":\"La3QxvUgFwKz2jjQR2HSrwaKcRgotf4tGVkMJx\",\"divisibility\":7,"
                           ...
                           "\"https://bfxt-icons.ams3.digitaloceanspaces.com/"
    ...
    BFXTTokenMetaData tokenMetaData;
    ...
    EXPECT_EQ(
        ...
        "https://bfxt-icons.ams3.digitaloceanspaces.com/24d000d478d72d6a43b89bbabbe41a45acde9ba0.png");
...
TEST(bfxt_tests, token_meta_data_without_url)
{
    std::string metadata =
...
TEST(bfxt_tests, wallet_tests)
{
    BFXTWallet                      wallet1;
    typedef boost::filesystem::path Path;
    auto TestWalletCachePath = Path(TEST_ROOT_PATH) / Path("/data") / BFXTWalletCacheFileName;
...
TEST(bfxt_tests, amount_to_int_random)
{
    ...
    {
        // test the maximum
        std::string numHex          = BFXTScript::NumberToHexBFXTAmount(rangeMax);
        BFXTInt     amountToCompare = BFXTScript::BFXTAmountHexToNumber(numHex);
    ...
    for (int i = 0; i < tries_count; i++) {
        ...
        BFXTInt     amount          = amount64;
        std::string numHex          = BFXTScript::NumberToHexBFXTAmount(amount);
        BFXTInt     amountToCompare = BFXTScript::BFXTAmountHexToNumber(numHex);
        EXPECT_EQ(amountToCompare, amount);
    }
}

TEST(bfxt_tests, amount_to_int)
{
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("69892a92"), 999901700);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("c007b60b6f687a"), 8478457292922);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("40ef54"), 38290000);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("201f"), 1000000000000000);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("60b0b460"), 723782);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("5545e1"), 871340);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("c007b60b6f687a"), 8478457292922);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("11"), 17);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("2011"), 10);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("2012"), 100);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("4bb3c1"), 479320);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("68c7e5b3"), 9207387000);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("8029990f1a"), 8723709100);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("a09c47f7b1a1"), 839027891720);
    EXPECT_EQ(BFXTScript::BFXTAmountHexToNumber("c0a60eea1aa8fd"), 182582987368701);

    EXPECT_ANY_THROW(BFXTScript::BFXTAmountHexToNumber("x"));
    EXPECT_ANY_THROW(BFXTScript::BFXTAmountHexToNumber(" "));
    EXPECT_ANY_THROW(BFXTScript::BFXTAmountHexToNumber("ssdsdmwdmo"));
    EXPECT_ANY_THROW(
        BFXTScript::BFXTAmountHexToNumber("999999999999999999999999999999999999999999999999"));

    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(999901700), "69892a92");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(8478457292922), "c007b60b6f687a");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(38290000), "40ef54");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(1000000000000000), "201f");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(723782), "60b0b460");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(871340), "5545e1");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(8478457292922), "c007b60b6f687a");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(17), "11");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(100), "2012");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(479320), "4bb3c1");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(9207387000), "68c7e5b3");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(8723709100), "8029990f1a");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(839027891720), "a09c47f7b1a1");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(182582987368701), "c0a60eea1aa8fd");

    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(999999999997990), "c38d7ea4c67826");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(276413656646664), "c0fb6591d0c408");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(9731165496688), "c008d9b6a9a570");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(943721684679640), "c35a4f53c83bd8");
    EXPECT_EQ(BFXTScript::NumberToHexBFXTAmount(1412849080), "80435eb161");
}

TEST(bfxt_tests, script_transfer)
{
    // transfer some tokens
    const std::string                    toParse_transfer = "4e5401150069892a92";
    std::shared_ptr<BFXTScript>          script           = BFXTScript::ParseScript(toParse_transfer);
    std::shared_ptr<BFXTScript_Transfer> script_transfer =
        std::dynamic_pointer_cast<BFXTScript_Transfer>(script);
    ...
    EXPECT_EQ(script_transfer->getTxType(), BFXTScript::TxType::TxType_Transfer);
...
TEST(bfxt_tests, script_issuance_allowed_chars_in_token_symbol)
{
    std::string                 toParse_issuance;
    std::shared_ptr<BFXTScript> script;
    {
        ...
        EXPECT_NO_THROW(script = BFXTScript::ParseScript(toParse_issuance));
    }
    {
        // -IBBL name
        toParse_issuance = "4e5401012d4942424cab10c04e20e0aec73d58c8fbf2a9c26a6dc3ed666c7b80fef2"
                           "15620c817703b1e5d8b1870211ce7cdf50718b4789245fb80f58992019002019f0";
        EXPECT_THROW(script = BFXTScript::ParseScript(toParse_issuance), std::runtime_error);
    }
    {
...
TEST(bfxt_tests, script_issuance)
{
    {
        // issue NIBBL
        ...
        std::string toParse_issuance =
            ...
            "15620c817703b1e5d8b1870211ce7cdf50718b4789245fb80f58992019002019f0";
        std::shared_ptr<BFXTScript>          script = BFXTScript::ParseScript(toParse_issuance);
        std::shared_ptr<BFXTScript_Issuance> script_issuance =
            std::dynamic_pointer_cast<BFXTScript_Issuance>(script);
        EXPECT_NE(script_issuance.get(), nullptr);
        EXPECT_EQ(script_issuance->getAggregationPolicy(),
                  BFXTScript::IssuanceFlags::AggregationPolicy::AggregationPolicy_Aggregatable);
        ...
        EXPECT_EQ(script_issuance->getTxType(), BFXTScript::TxType::TxType_Issuance);
...
TEST(bfxt_tests, script_burn)
{
    // burn some tokens
    std::string                      toParse_burn = "4e5401251f2013";
    std::shared_ptr<BFXTScript>      script       = BFXTScript::ParseScript(toParse_burn);
    std::shared_ptr<BFXTScript_Burn> script_burn  = std::dynamic_pointer_cast<BFXTScript_Burn>(script);
    ...
    EXPECT_EQ(script_burn->getTxType(), BFXTScript::TxType::TxType_Burn);
...
TEST(bfxt_tests, script_get_amount_size)
{
    EXPECT_EQ(BFXTScript::CalculateAmountSize(boost::algorithm::unhex(std::string("11"))[0]),
              static_cast<unsigned>(1));
    EXPECT_EQ(BFXTScript::CalculateAmountSize(boost::algorithm::unhex(std::string("2012"))[0]),
              static_cast<unsigned>(2));
    EXPECT_EQ(BFXTScript::CalculateAmountSize(boost::algorithm::unhex(std::string("4bb3c1"))[0]),
              static_cast<unsigned>(3));
    EXPECT_EQ(BFXTScript::CalculateAmountSize(boost::algorithm::unhex(std::string("68c7e5b3"))[0]),
              static_cast<unsigned>(4));
    EXPECT_EQ(BFXTScript::CalculateAmountSize(boost::algorithm::unhex(std::string("8029990f1a"))[0]),
              static_cast<unsigned>(5));
    EXPECT_EQ(BFXTScript::CalculateAmountSize(boost::algorithm::unhex(std::string("a09c47f7b1a1"))[0]),
              static_cast<unsigned>(6));
    EXPECT_EQ(BFXTScript::CalculateAmountSize(boost::algorithm::unhex(std::string("c0a60eea1aa8fd"))[0]),
...
TEST(bfxt_tests, parsig_bfxt_from_ctransaction_issuance)
{
    // issuance
    ...
    EXPECT_TRUE(BFXTTransaction::IsTxBFXT(&tx, &opReturnArg));
    std::shared_ptr<BFXTScript>          script = BFXTScript::ParseScript(opReturnArg);
    std::shared_ptr<BFXTScript_Issuance> script_issuance =
        std::dynamic_pointer_cast<BFXTScript_Issuance>(script);
    EXPECT_NE(script_issuance.get(), nullptr);
    EXPECT_EQ(script_issuance->getAggregationPolicy(),
    ...
    std::vector<std::pair<CTransaction, BFXTTransaction>> inputs{{txVinA, BFXTTransaction()}};
    ////////////////////////////////////////////////////

    for (auto&& input : inputs) {
        input.second.readBFXTDataFromTx_minimal(input.first);
    }

    BFXTTransaction bfxttx;
    EXPECT_NO_THROW(bfxttx.readBFXTDataFromTx(tx, inputs));
    EXPECT_EQ(bfxttx.getTxInCount(), static_cast<unsigned>(1));
    EXPECT_EQ(bfxttx.getTxIn(0).getNumOfTokens(), static_cast<unsigned>(0));
    EXPECT_EQ(bfxttx.getTxOutCount(), static_cast<unsigned>(3));
    EXPECT_EQ(bfxttx.getTxOut(0).tokenCount(), static_cast<unsigned>(1));
    EXPECT_EQ(bfxttx.getTxOut(1).tokenCount(), static_cast<unsigned>(0));
    EXPECT_EQ(bfxttx.getTxOut(2).tokenCount(), static_cast<unsigned>(0));
    EXPECT_EQ(bfxttx.getTxOut(0).getToken(0).getAmount(), static_cast<unsigned>(1000000000));
    EXPECT_EQ(bfxttx.getTxOut(0).getToken(0).getDivisibility(), static_cast<unsigned>(7));
    EXPECT_EQ(bfxttx.getTxOut(0).getToken(0).getIssueTxId().ToString(),
              "66216fa9cc0167568c3e5f8b66e7fe3690072f66a5f41df222327de7af10ff80");
    EXPECT_TRUE(bfxttx.getTxOut(0).getToken(0).getLockStatus());
    EXPECT_EQ(bfxttx.getTxOut(0).getToken(0).getTokenSymbol(), "NIBBL");
    EXPECT_EQ(bfxttx.getTxHash().ToString(),
              "66216fa9cc0167568c3e5f8b66e7fe3690072f66a5f41df222327de7af10ff80");
    EXPECT_EQ(bfxttx.getTxOut(0).getToken(0).getTokenId(), "LaA5grPQMDhwvciWFqxwG1ySDqNHAgms1yLrPp");

    EXPECT_EQ(bfxttx.getTxIn(0).getPrevout().getHash().ToString(),
              "c55dd5271dd8a9aa35a7f6c393a0eb24bcc50116bf15b49f4e760d3e9a138120");
    EXPECT_EQ(bfxttx.getTxIn(0).getPrevout().getIndex(), static_cast<unsigned>(1));
}

TEST(bfxt_tests, parsig_bfxt_from_ctransaction_transfer_1)
{
    // transfer
    std::string transaction =
    ...
    CTransaction    txVinA = TxFromHex(vinA);
    BFXTTransaction bfxttxVinA;

    BFXTTokenTxData vinA_vout0_token0;
    ...
    vinA_vout0.__manualSet(
        ...
        std::vector<BFXTTokenTxData>({vinA_vout0_token0}), "NY8d4F6EZQH1y5KoqvdybTUgfwAMUYW3qF");

    BFXTTokenTxData vinA_vout1_token0;
    ...
    vinA_vout1.__manualSet(
        ...
        std::vector<BFXTTokenTxData>({vinA_vout1_token0}), "NRhhZd2hzHmtHWGtQLY8Kjnt5tabyeVSxw");

    BFXTTxOut vinA_vout2;
    vinA_vout2.__manualSet(10000, "6a0c4e5401150020120169895252", "OP_RETURN 4e5401150020120169895252",
                           std::vector<BFXTTokenTxData>(), "");

    BFXTTxOut vinA_vout3;
    vinA_vout3.__manualSet(
        40000, "76a9143f7eb8c3da2cbe606fd5d46b11ab9211705770db88ac",
        "OP_DUP OP_HASH160 3f7eb8c3da2cbe606fd5d46b11ab9211705770db OP_EQUALVERIFY OP_CHECKSIG",
        std::vector<BFXTTokenTxData>(), "NRhhZd2hzHmtHWGtQLY8Kjnt5tabyeVSxw");

    // inputs are not important
    bfxttxVinA.__manualSet(1,
                           uint256("1766a9150953392de523f9420a2e32f993bb572e79f465de78ef96831494b347"),
                           std::vector<unsigned char>(), std::vector<BFXTTxIn>{},
                           std::vector<BFXTTxOut>{vinA_vout0, vinA_vout1, vinA_vout2, vinA_vout3}, 0,
                           1520653825000, BFXTTxType_TRANSFER);
    ...
    BFXTTransaction bfxttxVinB;

    BFXTTokenTxData vinB_vout0_token0;
    ...
    vinB_vout0.__manualSet(
        ...
        std::vector<BFXTTokenTxData>({vinB_vout0_token0}), "NVKd1iq2UF8RZThEN4MDGMBcKnFPnuPF6v");

    BFXTTokenTxData vinB_vout1_token0;
    ...
    BFXTTxOut vinB_vout1;
    vinB_vout1.__manualSet(
        10000, "76a9143f7eb8c3da2cbe606fd5d46b11ab9211705770db88ac",
        "OP_DUP OP_HASH160 3f7eb8c3da2cbe606fd5d46b11ab9211705770db OP_EQUALVERIFY OP_CHECKSIG",
        std::vector<BFXTTokenTxData>({vinB_vout1_token0}), "NRhhZd2hzHmtHWGtQLY8Kjnt5tabyeVSxw");

    BFXTTxOut vinB_vout2;
    vinB_vout2.__manualSet(10000, "6a0c4e5401150020120169895c32", "OP_RETURN 4e5401150020120169895c32",
                           std::vector<BFXTTokenTxData>(), "");

    BFXTTxOut vinB_vout3;
    ...
    // inputs are not important
    bfxttxVinB.__manualSet(1,
                           uint256("111481401fbd842c5aa1b9420db8c5ef7e94d9ac3b3d3b7e2b2cb6c7b0650612"),
                           std::vector<unsigned char>(), std::vector<BFXTTxIn>{},
                           std::vector<BFXTTxOut>{vinB_vout0, vinB_vout1, vinB_vout2, vinB_vout3}, 0,
                           1520653825000, BFXTTxType_TRANSFER);

    std::vector<std::pair<CTransaction, BFXTTransaction>> inputs{std::make_pair(txVinA, bfxttxVinA),
                                                                 std::make_pair(txVinB, bfxttxVinB)};

    ////////////////////////////////////////////

    BFXTTransaction bfxttx;
    ASSERT_NO_THROW(bfxttx.readBFXTDataFromTx(tx, inputs));
    EXPECT_EQ(bfxttx.getTxInCount(), static_cast<unsigned>(2));
    // inputs are unknown, so no more tests
    EXPECT_EQ(bfxttx.getTxOutCount(), static_cast<unsigned>(4));
    EXPECT_EQ(bfxttx.getTxOut(0).tokenCount(), static_cast<unsigned>(1));
    EXPECT_EQ(bfxttx.getTxOut(0).getToken(0).getAmount(), static_cast<uint64_t>(100));
    EXPECT_EQ(bfxttx.getTxOut(1).tokenCount(), static_cast<unsigned>(1));
    EXPECT_EQ(bfxttx.getTxOut(1).getToken(0).getAmount(), static_cast<uint64_t>(999965200));
    EXPECT_EQ(bfxttx.getTxOut(2).tokenCount(), static_cast<unsigned>(0));
    EXPECT_EQ(bfxttx.getTxOut(3).tokenCount(), static_cast<unsigned>(0));
    EXPECT_EQ(bfxttx.getTxHash().ToString(),
              "006bd375946e903aa20aced1b411d61d14175488650e1deab3cb5ff8f354467d");
    ...
    EXPECT_EQ(bfxttx.getTxIn(0).getPrevout().getIndex(), static_cast<unsigned>(1));
    EXPECT_EQ(bfxttx.getTxIn(1).getPrevout().getHash().ToString(),
              "111481401fbd842c5aa1b9420db8c5ef7e94d9ac3b3d3b7e2b2cb6c7b0650612");
    EXPECT_EQ(bfxttx.getTxIn(1).getPrevout().getIndex(), static_cast<unsigned>(3));
}

TEST(bfxt_tests, parsig_bfxt_from_ctransaction_transfer_2_with_change)
{
    // transfer
    std::string transaction =
        "01000000f554a35a0247b394148396ef78de65f4792e57bb93f9322e0a42f923e52d39530915a96617010000006"
    ...
    std::vector<std::pair<CTransaction, BFXTTransaction>> inputs{std::make_pair(txVinB, bfxttxVinB),
                                                                 std::make_pair(txVinA, bfxttxVinA)};
    ...
    EXPECT_EQ(bfxttx.getTxOut(1).getToken(0).getAmount(), static_cast<uint64_t>(999965200));
    EXPECT_EQ(bfxttx.getTxOut(2).tokenCount(), static_cast<unsigned>(0));
    EXPECT_EQ(bfxttx.getTxOut(3).tokenCount(), static_cast<unsigned>(1));
    EXPECT_EQ(bfxttx.getTxOut(3).getToken(0).getAmount(), static_cast<uint64_t>(200));
    EXPECT_EQ(bfxttx.getTxHash().ToString(),
              "006bd375946e903aa20aced1b411d61d14175488650e1deab3cb5ff8f354467d");
...
TEST(bfxt_tests, parsig_bfxt_from_ctransaction_burn_with_transfer_1)
{
    // burn with transfer
    std::string transaction =
    ...
    vinA_vout0.__manualSet(
        10000, "76a91486061d16eafa0ea7a6be8875fb5bbc09a5f210a588ac",
        "OP_DUP OP_HASH160 86061d16eafa0ea7a6be8875fb5bbc09a5f210a5 OP_EQUALVERIFY OP_CHECKSIG",
        std::vector<BFXTTokenTxData>({vinA_vout0_token0}), "NS8riWSXkBwWLK1wDDqReNHiLA5pTHeHbg");
    ...
    vinA_vout2.__manualSet(10000, "6a0d4e54011500201201802fadc751",
                           "OP_RETURN 4e54011500201201802fadc751", std::vector<BFXTTokenTxData>(), "");
    ...
    vinB_vout0.__manualSet(
        10000, "76a91486061d16eafa0ea7a6be8875fb5bbc09a5f210a588ac",
        "OP_DUP OP_HASH160 86061d16eafa0ea7a6be8875fb5bbc09a5f210a5 OP_EQUALVERIFY OP_CHECKSIG",
        std::vector<BFXTTokenTxData>({vinB_vout0_token0}), "NMiqBPp9WkE7bZo3d1CLcVd1orGdapY1VN");
    ...
    BFXTTransaction bfxttxVinC;

    BFXTTokenTxData vinC_vout0_token0;
    ...
    vinC_vout0.__manualSet(
        ...
        std::vector<BFXTTokenTxData>({vinC_vout0_token0}), "NgVBFMAt1moZrPS2LX7ud7zJGDd8rtNsvu");

    BFXTTokenTxData vinC_vout1_token0;
    ...
    BFXTTxOut vinC_vout1;
    vinC_vout1.__manualSet(
        10000, "76a9143f7eb8c3da2cbe606fd5d46b11ab9211705770db88ac",
        "OP_DUP OP_HASH160 3f7eb8c3da2cbe606fd5d46b11ab9211705770db OP_EQUALVERIFY OP_CHECKSIG",
        std::vector<BFXTTokenTxData>({vinC_vout1_token0}), "NRhhZd2hzHmtHWGtQLY8Kjnt5tabyeVSxw");

    BFXTTxOut vinC_vout2;
    vinC_vout2.__manualSet(10000, "6a0c4e5401150020120169894a92", "OP_RETURN 4e5401150020120169894a92",
                           std::vector<BFXTTokenTxData>(), "");

    BFXTTxOut vinC_vout3;
    ...
    // inputs are not important
    bfxttxVinC.__manualSet(1,
                           uint256("0132cf38f3a298403427e8c3203f030141efff9c0d3a3fb7fef10ab4452771df"),
                           std::vector<unsigned char>(), std::vector<BFXTTxIn>{},
                           std::vector<BFXTTxOut>{vinC_vout0, vinC_vout1, vinC_vout2, vinC_vout3}, 0,
                           1520653825000, BFXTTxType_TRANSFER);
    ...
    BFXTTransaction bfxttxVinD;

    BFXTTokenTxData vinD_vout0_token0;
    ...
    vinD_vout0.__manualSet(
        ...
        std::vector<BFXTTokenTxData>({vinD_vout0_token0}), "NYXCmnTDhV8hBx7QB1QrqG6XqSutzxAgQ7");

    BFXTTokenTxData vinD_vout1_token0;
    ...
    BFXTTxOut vinD_vout1;
    vinD_vout1.__manualSet(
        10000, "76a9143f7eb8c3da2cbe606fd5d46b11ab9211705770db88ac",
        "OP_DUP OP_HASH160 3f7eb8c3da2cbe606fd5d46b11ab9211705770db OP_EQUALVERIFY OP_CHECKSIG",
        std::vector<BFXTTokenTxData>({vinD_vout1_token0}), "NRhhZd2hzHmtHWGtQLY8Kjnt5tabyeVSxw");

    BFXTTxOut vinD_vout2;
    vinD_vout2.__manualSet(10000, "6a0c4e5401150020120169894032", "OP_RETURN 4e5401150020120169894032",
                           std::vector<BFXTTokenTxData>(), "");

    BFXTTxOut vinD_vout3;
    ...
    // inputs are not important
    bfxttxVinD.__manualSet(1,
                           uint256("0317c3f20338cd8ea142c389e65670554c676905d2024a58775f695fe88f1298"),
                           std::vector<unsigned char>(), std::vector<BFXTTxIn>{},
                           std::vector<BFXTTxOut>{vinD_vout0, vinD_vout1, vinD_vout2, vinD_vout3}, 0,
                           1520653825000, BFXTTxType_TRANSFER);

    std::vector<std::pair<CTransaction, BFXTTransaction>> inputs{
        std::make_pair(txVinA, bfxttxVinA), std::make_pair(txVinB, bfxttxVinB),
        std::make_pair(txVinC, bfxttxVinC), std::make_pair(txVinD, bfxttxVinD)};

    std::string opReturnArg;
    EXPECT_TRUE(BFXTTransaction::IsTxBFXT(&tx, &opReturnArg));
    std::shared_ptr<BFXTScript>      scriptPtr  = BFXTScript::ParseScript(opReturnArg);
    std::shared_ptr<BFXTScript_Burn> scriptPtrD = std::dynamic_pointer_cast<BFXTScript_Burn>(scriptPtr);
    EXPECT_NE(scriptPtr.get(), nullptr);
    EXPECT_NE(scriptPtrD.get(), nullptr);
    EXPECT_EQ(scriptPtrD->getTxType(), BFXTScript::TxType::TxType_Burn);

    BFXTTransaction bfxttx;
    EXPECT_NO_THROW(bfxttx.readBFXTDataFromTx(tx, inputs));
    EXPECT_EQ(bfxttx.getTxInCount(), static_cast<unsigned>(4));
    // inputs are unknown, so no more tests
    EXPECT_EQ(bfxttx.getTxOutCount(), static_cast<unsigned>(3));
    EXPECT_EQ(bfxttx.getTxOut(0).tokenCount(), static_cast<unsigned>(1));
    EXPECT_EQ(bfxttx.getTxOut(0).getToken(0).getAmount(), static_cast<uint64_t>(10));
    EXPECT_EQ(bfxttx.getTxOut(1).tokenCount(), static_cast<unsigned>(0));
    EXPECT_EQ(bfxttx.getTxOut(2).tokenCount(), static_cast<unsigned>(1));
    EXPECT_EQ(bfxttx.getTxOut(2).getToken(0).getAmount(), static_cast<unsigned>(999897350));
    ...
    EXPECT_EQ(bfxttx.getTxIn(1).getPrevout().getIndex(), static_cast<unsigned>(3));
    EXPECT_EQ(bfxttx.getTxIn(2).getPrevout().getHash().ToString(),
              "0132cf38f3a298403427e8c3203f030141efff9c0d3a3fb7fef10ab4452771df");
    EXPECT_EQ(bfxttx.getTxIn(2).getPrevout().getIndex(), static_cast<unsigned>(3));
    EXPECT_EQ(bfxttx.getTxIn(3).getPrevout().getHash().ToString(),
              "0317c3f20338cd8ea142c389e65670554c676905d2024a58775f695fe88f1298");
    EXPECT_EQ(bfxttx.getTxIn(3).getPrevout().getIndex(), static_cast<unsigned>(3));
}

std::string GetRawTxURL(const std::string& txid, bool testnet)
{
    if (!testnet) {
        return "https://bfxtnode.nebl.io/ins/rawtx/" + txid;
    } else {
        return "https://bfxtnode.nebl.io/testnet/ins/rawtx/" + txid;
    }
}
...
std::string BFXTTests_GetTxidListFileName(bool testnet)
{
    if (!testnet) {
        return "bfxttxids_to_test.txt";
    } else {
        return "bfxttxids_to_test_testnet.txt";
    }
}

std::string BFXTTests_GetRawBFXTxsFileName(bool testnet)
{
    if (!testnet) {
        return "txs_bfxttests_raw_bfx_txs.json";
    } else {
        return "txs_bfxttests_raw_bfx_txs_testnet.json";
    }
}

std::string BFXTTests_GetBFXTRawTxsFileName(bool testnet)
{
    if (!testnet) {
        return "txs_bfxttests_bfxt_txs.json";
    } else {
        return "txs_bfxttests_bfxt_txs_testnet.json";
    }
}
...
std::string GetRawTxOnline(const std::string& txid, bool testnet)
{
    ...
    std::string         rawTx    = BFXTTools::GetStrField(rawTxObj, "rawtx");
    return rawTx;
}

std::vector<std::pair<CTransaction, BFXTTransaction>> GetBFXTInputsOnline(const CTransaction& tx,
                                                                          bool                testnet)
{
    std::vector<std::pair<CTransaction, BFXTTransaction>> inputs;
    ...
    for (int i = 0; i < (int)tx.vin.size(); i++) {
        ...
        BFXTTransaction inputBFXTTx = BFXTAPICalls::RetrieveData_TransactionInfo(inputTxid, testnet);

        inputs.push_back(std::make_pair(inputTx, inputBFXTTx));
    }

    return inputs;
}

void TestBFXTTxParsing_onlyRead(const CTransaction& tx, bool testnet)
{
...
{
    // these transactions has an encoded BFXT amount that is correct but unequivalent to our encoding
    // default
...
void TestBFXTTxParsing(const CTransaction& tx, bool testnet)
{
    const std::string&    txid       = tx.GetHash().ToString();
    const BFXTTransaction bfxttx_ref = BFXTAPICalls::RetrieveData_TransactionInfo(txid, testnet);
    ...
    EXPECT_EQ(bfxttx.getTxOutCount(), bfxttx_ref.getTxOutCount()) << "Failed tx: " << txid;
    for (int i = 0; i < (int)bfxttx.getTxOutCount(); i++) {
        ASSERT_EQ(bfxttx.getTxOut(i).tokenCount(), bfxttx_ref.getTxOut(i).tokenCount())
            << "Failed tx: " << txid << "; Failed at TxOut: " << i;
        EXPECT_EQ(bfxttx_ref.getTxOut(i).getValue(), bfxttx.getTxOut(i).getValue());
        EXPECT_EQ(bfxttx_ref.getTxOut(i).getAddress(), bfxttx.getTxOut(i).getAddress());
        std::string script1 = bfxttx_ref.getTxOut(i).getScriptPubKeyHex();
        std::string script2 = bfxttx.getTxOut(i).getScriptPubKeyHex();
        ...
        EXPECT_EQ(bfxttx_ref.getTxOut(i).getScriptPubKeyAsm(), bfxttx.getTxOut(i).getScriptPubKeyAsm());
        for (int j = 0; j < (int)bfxttx.getTxOut(i).tokenCount(); j++) {
            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getAmount(),
                      bfxttx_ref.getTxOut(i).getToken(j).getAmount())
                << "Failed tx: " << txid << "; Failed at TxOut: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getAggregationPolicy(),
                      bfxttx_ref.getTxOut(i).getToken(j).getAggregationPolicy())
                << "Failed tx: " << txid << "; Failed at TxOut: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getDivisibility(),
                      bfxttx_ref.getTxOut(i).getToken(j).getDivisibility())
                << "Failed tx: " << txid << "; Failed at TxOut: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getIssueTxId().ToString(),
                      bfxttx_ref.getTxOut(i).getToken(j).getIssueTxId().ToString())
                << "Failed tx: " << txid << "; Failed at TxOut: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getLockStatus(),
                      bfxttx_ref.getTxOut(i).getToken(j).getLockStatus())
                << "Failed tx: " << txid << "; Failed at TxOut: " << i << "; at token: " << j;
            //            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getTokenSymbol(),
            //                      bfxttx_ref.getTxOut(i).getToken(j).getTokenSymbol())
            //                << "Failed tx: " << txid;
        }
    }

    EXPECT_EQ(bfxttx.getTxInCount(), bfxttx_ref.getTxInCount());
    for (int i = 0; i < (int)bfxttx.getTxInCount(); i++) {
        ASSERT_EQ(bfxttx.getTxIn(i).getNumOfTokens(), bfxttx_ref.getTxIn(i).getNumOfTokens())
            << "Failed tx: " << txid << "; Failed at TxIn: " << i;
        EXPECT_EQ(bfxttx_ref.getTxIn(i).getOutPoint(), bfxttx.getTxIn(i).getOutPoint());
        EXPECT_EQ(bfxttx_ref.getTxIn(i).getPrevout(), bfxttx.getTxIn(i).getPrevout());
        std::string sig1 = bfxttx_ref.getTxIn(i).getScriptSigHex();
        std::string sig2 = bfxttx.getTxIn(i).getScriptSigHex();
        std::transform(sig1.begin(), sig1.end(), sig1.begin(), ::toupper);
        std::transform(sig2.begin(), sig2.end(), sig2.begin(), ::toupper);
        EXPECT_EQ(sig1, sig2);
        for (int j = 0; j < (int)bfxttx.getTxIn(i).getNumOfTokens(); j++) {
            EXPECT_EQ(bfxttx.getTxIn(i).getToken(j).getAmount(),
                      bfxttx_ref.getTxIn(i).getToken(j).getAmount())
                << "Failed tx: " << txid << "; Failed at TxIn: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxIn(i).getToken(j).getAggregationPolicy(),
                      bfxttx_ref.getTxIn(i).getToken(j).getAggregationPolicy())
                << "Failed tx: " << txid << "; Failed at TxIn: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxIn(i).getToken(j).getDivisibility(),
                      bfxttx_ref.getTxIn(i).getToken(j).getDivisibility())
                << "Failed tx: " << txid << "; Failed at TxIn: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxIn(i).getToken(j).getIssueTxId(),
                      bfxttx_ref.getTxIn(i).getToken(j).getIssueTxId())
                << "Failed tx: " << txid << "; Failed at TxIn: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxIn(i).getToken(j).getLockStatus(),
                      bfxttx_ref.getTxIn(i).getToken(j).getLockStatus())
                << "Failed tx: " << txid << "; Failed at TxIn: " << i << "; at token: " << j;
            EXPECT_EQ(bfxttx.getTxIn(i).getToken(j).getTokenSymbol(),
                      bfxttx_ref.getTxIn(i).getToken(j).getTokenSymbol())
                << "Failed tx: " << txid << "; Failed at TxIn: " << i << "; at token: " << j;
        }
    }

    EXPECT_EQ(bfxttx.getTxHash(), bfxttx_ref.getTxHash()) << "Failed tx: " << txid;
}

void TestBFXTTxParsing(const std::string& txid, bool testnet)
{
    ...
    TestBFXTTxParsing(tx, testnet);
}

void TestSingleBFXTTxParsingLocally(const CTransaction&                                 tx,
                                    const std::unordered_map<std::string, std::string>& nebltxs_map,
                                    const std::unordered_map<std::string, std::string>& bfxttxs_map)
{
    const std::string& txid           = tx.GetHash().ToString();
    const std::string  bfxttx_ref_str = bfxttxs_map.find(txid)->second;
    BFXTTransaction    bfxttx_ref;
    bfxttx_ref.importJsonData(bfxttx_ref_str);
    EXPECT_TRUE(tx.CheckTransaction()) << "Failed tx: " << txid;
    ...
    for (int i = 0; i < (int)tx.vin.size(); i++) {
        ...
        const std::string inputBFXTTxStr = bfxttxs_map.find(inputTxid)->second;
        BFXTTransaction   inputBFXTTx;
        inputBFXTTx.importJsonData(inputBFXTTxStr);
    ...
    for (int i = 0; i < (int)bfxttx.getTxOutCount(); i++) {
        ...
        for (int j = 0; j < (int)bfxttx.getTxOut(i).tokenCount(); j++) {
            ...
            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getDivisibility(),
                      bfxttx_ref.getTxOut(i).getToken(j).getDivisibility())
                << "Failed tx: " << txid;
            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getIssueTxId(),
                      bfxttx_ref.getTxOut(i).getToken(j).getIssueTxId())
                << "Failed tx: " << txid;
            EXPECT_EQ(bfxttx.getTxOut(i).getToken(j).getLockStatus(),
                      bfxttx_ref.getTxOut(i).getToken(j).getLockStatus())
                << "Failed tx: " << txid;
            // skipping testing input token name as it's not available in the BFXT API
...
void TestSingleBFXTTxParsingLocally(const std::string&                                  txid,
                                    const std::unordered_map<std::string, std::string>& nebltxs_map,
                                    const std::unordered_map<std::string, std::string>& bfxttxs_map)
{
    ...
    if (BFXTTransaction::IsTxBFXT(&tx)) {
        try {
            TestSingleBFXTTxParsingLocally(tx, nebltxs_map, bfxttxs_map);
        } catch (...) {
...
void TestBFXTTxParsingLocally(bool testnet)
{
    ...
    std::unordered_map<std::string, std::string> bfxttxs_map;
    std::unordered_map<std::string, std::string> nebltxs_map;

    std::vector<std::string> txids = read_line_by_line(BFXTTests_GetTxidListFileName(testnet));

    // save memory by ensuring the destruction of json objects
    {
        json_spirit::Object nebltxs = read_json_obj(BFXTTests_GetRawBFXTxsFileName(testnet));
        json_spirit::Object bfxttxs = read_json_obj(BFXTTests_GetBFXTRawTxsFileName(testnet));

        for (const auto& el : nebltxs) {
            nebltxs_map[el.name_] = el.value_.get_str();
        }
        for (const auto& el : bfxttxs) {
            bfxttxs_map[el.name_] = boost::algorithm::unhex(el.value_.get_str());
        }
    }
    ...
    for (const auto& txid : txids) {
        ...
        TestSingleBFXTTxParsingLocally(txid, nebltxs_map, bfxttxs_map);
    }
}
...
void DownloadData(bool testnet)
{
    ...
    std::unordered_map<std::string, std::string> rawBFXTxsMap;
    std::unordered_map<std::string, std::string> bfxtTxsMap;

    json_spirit::Object rawBFXTxs;
    json_spirit::Object bfxtTxs;
    ...
    for (uint64_t i = 0; i < (uint64_t)txids.size(); i++) {
        ...
        CTransaction      tx         = TxFromHex(rawTx);
        const std::string bfxttx_ref = BFXTAPICalls::RetrieveData_TransactionInfo_Str(txids[i], testnet);

        rawBFXTxsMap[txids[i]] = rawTx;
        bfxtTxsMap[txids[i]]      = boost::algorithm::hex(bfxttx_ref);
        ...
        for (int i = 0; i < (int)tx.vin.size(); i++) {
            ...
            std::string         inputRawTx    = BFXTTools::GetStrField(inputRawTxObj, "rawtx");

            std::string inputBFXTTx = BFXTAPICalls::RetrieveData_TransactionInfo_Str(inputTxid, testnet);

            rawBFXTxsMap[inputTxid] = inputRawTx;
            bfxtTxsMap[inputTxid]      = boost::algorithm::hex(inputBFXTTx);
        }
    }

    for (const auto& el : rawBFXTxsMap) {
        rawBFXTxs.push_back(json_spirit::Pair(el.first, el.second));
    }
    for (const auto& el : bfxtTxsMap) {
        bfxtTxs.push_back(json_spirit::Pair(el.first, el.second));
    }

    std::string f1 = BFXTTests_GetRawBFXTxsFileName(testnet);
    std::string f2 = BFXTTests_GetBFXTRawTxsFileName(testnet);

    std::remove(f1.c_str());
    std::remove(f2.c_str());

    write_json_file(rawBFXTxs, f1);
    write_json_file(bfxtTxs, f2);
}
...
void DownloadPreMadeData(bool testnet)
{
    ...
    files.push_back(BFXTTests_GetTxidListFileName(testnet));
    files.push_back(BFXTTests_GetRawBFXTxsFileName(testnet));
    files.push_back(BFXTTests_GetBFXTRawTxsFileName(testnet));
...
TEST(bfxt_tests, download_data_to_files)
{
    DownloadData(false);
    DownloadData(true);
}
...
TEST(bfxt_tests, parsig_bfxt_from_ctransaction_automated)
{
    EXPECT_NO_THROW(TestBFXTTxParsingLocally(false));
    EXPECT_NO_THROW(TestBFXTTxParsingLocally(true));
}

#elif defined UNITTEST_DOWNLOAD_PREMADE_TX_DATA_AND_RUN_PARSE_TESTS
TEST(bfxt_tests, download_premade_data_to_files_and_run_parse_test)
{
    DownloadPreMadeData(true);
    TestBFXTTxParsingLocally(true);
    DownloadPreMadeData(false);
    TestBFXTTxParsingLocally(false);
}
#endif



TEST(bfxt_tests, construct_scripts)
{
    {
        // test transfer instruction string script creator
        BFXTScript::TransferInstruction inst_manual;
        inst_manual.amount      = 1000000000;
        inst_manual.skipInput   = 0;
        inst_manual.outputIndex = 0;
        std::string ti = boost::algorithm::hex(BFXTScript::TransferInstructionToBinScript(inst_manual));
    ...
    }
    {
        ...
        std::string                      toParse_burn = "4e5401251f2013";
        std::shared_ptr<BFXTScript>      script       = BFXTScript::ParseScript(toParse_burn);
        std::shared_ptr<BFXTScript_Burn> script_burn =
            std::dynamic_pointer_cast<BFXTScript_Burn>(script);
...
TEST(bfxt_tests, amend_tx_1)
{
    ...
    auto inputs = GetBFXTInputsOnline(tx, true);
    BFXTTransaction::AmendStdTxWithBFXT(tx, inputs, 1);
    ...
    std::string opRetArg;
    EXPECT_TRUE(BFXTTransaction::TxContainsOpReturn(&tx, &opRetArg));
    EXPECT_EQ(opRetArg, "4e54031001032051");

    auto scriptPtr  = BFXTScript::ParseScript(opRetArg);
    auto scriptPtrD = std::dynamic_pointer_cast<BFXTScript_Transfer>(scriptPtr);
...
TEST(bfxt_tests, amend_tx_2)
{
    ...
    EXPECT_FALSE(BFXTTransaction::TxContainsOpReturn(&tx));
}

TEST(bfxt_tests, amend_tx_3)
{
    fTestNet = true; // ensure testnet state will be reset on exit
    std::unique_ptr<int, void (*)(int*)> temp(new int, [](int* i) {
        fTestNet = false;
...
TEST(bfxt_tests, amend_tx_with_op_return)
{
    fTestNet = true; // ensure testnet state will be reset on exit
    std::unique_ptr<int, void (*)(int*)> temp(new int, [](int* i) {
        fTestNet = false;
    ...
    auto inputs = GetBFXTInputsOnline(tx, true);
    EXPECT_ANY_THROW(BFXTTransaction::AmendStdTxWithBFXT(tx, inputs, 1));
}
...
TEST(bfxt_tests, op_return_BFXTv3_test1)
{
...
TEST(bfxt_tests, metadata_decompression_issuance)
{
    ...
    std::shared_ptr<BFXTScript>          p  = BFXTScript::ParseScript(issuance_opRet);
    std::shared_ptr<BFXTScript_Issuance> pd = std::dynamic_pointer_cast<BFXTScript_Issuance>(p);
    ASSERT_NE(pd, nullptr);

    std::string expected =
        R"({"data":{"tokenName":"ROMAP","description":"BFX Roadmap","issuer":"bfxcrypto","urls":[{"name":"icon","url":"https://bfxt-icons.ams3.digitaloceanspaces.com/6789b550f714e34e8b98a6ed706c99f9276ffea9.png","mimeType":"image/png"}],"userData":{"meta":[{"key":"Feb 2017","value":"The market shows a need for simple blockchain solutions for business and the idea of BFX is born. Blockchain is seen as an immensely valuable technology for businesses small and large. However the tools and solutions available are too complicated for wide adoption. BFX was born to bring simple blockchain-based tools and services to the market to drive adoption of the technology in the business world.","type":"String"},{"key":"1st Half of Q3 2017","value":"BFX is publicly announced. BFX is announced publicly for the first time. GUI wallet applications for Windows, MacOS, and Linux are available on day one. The BFX Wallet source code is also publicly available on GitHub. The BFX Blockchain Network goes live on the day of the announcement.","type":"String"},{"key":"2nd Half of Q3 2017","value":"Acquire Top Talent to Build Out the BFX Core Development and Operations Teams. We’re hiring the best and brightest minds to join both our core development and operations teams. Are you a senior developer with years of experience in C++, .NET, Python, or advanced API implementations? Or do you want to market and deliver true business value based upon the blockchain technology you are so passionate about, while working with brilliant co-workers? If so, drop us a line and include your resume, we’ll be in touch soon!","type":"String"},{"key":"1st Half of Q4 2017","value":"Electrum Lite Wallets along with official Android & iOS Apps. Rounding out the BFX wallet application line up, we plan to launch Electrum-based wallets in Q4. Electrum based wallets, also known as “lite wallets”, provide a variety of benefits over the standard BFX wallet. Electrum wallets offload much of the normal processing that a wallet must do up to servers that we run in the cloud, making them faster, in many cases more secure, and much lighter on your computer to run. We will also be launching official Android & iOS applications this quarter. Giving you control over your BFX Coins (BFX) anywhere and anytime. BFX coins will be able to be sent and received on virtually every platform!","type":"String"},{"key":"2nd Half of Q4 2017","value":"Staking Wallets for Raspberry Pi and Docker. We will release staking wallets for both the Raspberry Pi and as a Docker image. Either of these unique solutions will give BFX users the ability to stake their coins on the BFX network on a low-power and efficient platform to earn stake rewards with their coins without running one of our traditional wallets on a PC fulltime. Learn more about staking and how to stake your coins here.","type":"String"},{"key":"Q1 2018","value":"RESTful APIs for Interacting with the BFX Network. We believe that the first step in unlocking the potential of  the BFX Blockchain in the enterprise world is to make the technology easier to consume. Through the use of a set of uniform and open-source RESTful APIs in a variety of languages (Python, Go, JS, Ruby, .NET, Java, Node.js) businesses large and small will rapidly deploy next-gen applications on the BFX Blockchain Network like never before seen in the blockchain ecosystem.","type":"String"},{"key":"Q2 2018","value":"Marketing Campaign Launch. Enterprise marketing campaign creation to drive the initial adoption of BFX blockchain technology in the business environment. Continuation of current strategies in addition to enhancing focus towards formation of market relationships for enterprise-wide blockchain solutions.","type":"String"},{"key":"Q3 2018","value":"Enterprise GO TO MARKET AND BFX APIV2 BETA LAUNCH. Identify and target niche areas of the market that can benefit from the simplification of blockchain technology. Examples include Healthcare records management, Supply Chain contract negotiation and validation, and online identity management applications. Based upon user-feedback and enterprise driven customer design requirements we are targeting the beta release of our BFX API Suite v2. Driving further innovation in blockchain protocol simplification and business adoption.","type":"String"},{"key":"Q4 2018","value":"IMPLEMENTATION AND DELIVERY OF BFX API SUITE V2 FOR ENTERPRISE CUSTOMERS. Focus will be on improving design requirements with our business partners to ensure enterprise customer adoption is seamlessly integrated with current enterprise processes. Iterative-based development work will continue throughout Q4 to ensure customer satisfaction and innovation in improving  business results in the wide variety of markets where our blockchain-based solutions provide inherent business value.","type":"String"},{"key":"2019+","value":"Iterative Innovation & Industry-Wide Adoption. The secure and decentralized exchange of information, credentials, records and tokens of value are all afforded to our users by the BFX platform. Learning from 2017 and 2018 successes and missteps, we will scale the delivery of our enterprise technology beyond niche markets, integrating into a multitude of world-wide opportunities that finally bring blockchain technology to the mainstream.","type":"String"}]}}})";

    EXPECT_EQ(ZlibDecompress(pd->getRawMetadata()), expected);
    EXPECT_EQ(pd->getInflatedMetadata(), expected);
}

TEST(bfxt_tests, metadata_decompression_transfer)
{
    ...
    std::shared_ptr<BFXTScript>          p  = BFXTScript::ParseScript(transfer_opRet);
    std::shared_ptr<BFXTScript_Transfer> pd = std::dynamic_pointer_cast<BFXTScript_Transfer>(p);
    ASSERT_NE(pd, nullptr);
...
TEST(bfxt_tests, random_compressions)
{
    for (int i = 0; i < 10; i++) {
...
TEST(bfxt_tests, bfxtv1_metadata_map)
{
    json_spirit::Value r;
    EXPECT_NO_THROW(r = GetBFXTv1IssuanceMetadataNode("La6h77fYdhWAAEgRqM1BJBwwnjc1XTSaPdhfxo"));
    EXPECT_ANY_THROW(GetBFXTv1IssuanceMetadataNode("La6h77fYdhWAAEgRqM1BJBwwnjc1XTSaPdhfxoxxxx"));
}

TEST(bfxt_tests, bfxt_metadata_parsing)
{
    BFXTTokenMetaData d1;
    d1.readSomeDataFromStandardJsonFormat(
        GetBFXTv1IssuanceMetadataNode("La4oBu5JpYfJhMYDgDV56NeHA9nGgt6jx3xFjH"));
    ...
    EXPECT_EQ(
        d1.getIconURL(),
        "https://bfxt-icons.ams3.digitaloceanspaces.com/be7e0f36a8ee11beecfcbccec7c784411910d3cb.png");
    EXPECT_EQ(d1.getIssuanceTxId(), 156);
    EXPECT_EQ(d1.getIconImageType(), "image/png");
}

TEST(bfxt_tests, bfxt_metadata_parsing_1)
{
    ...
    CDataStream bfxttx_ds(ParseHex(bfxttx_hex), SER_NETWORK, PROTOCOL_VERSION);
    ...
    BFXTTokenMetaData metadataObj = BFXTTransaction::GetFullBFXTIssuanceMetadata(tx, bfxttx);

    EXPECT_EQ(metadataObj.getTokenName(), "T36");
    EXPECT_EQ(metadataObj.getTokenDescription(), "T36");
    EXPECT_EQ(metadataObj.getTokenIssuer(), "bfxcrypto");
    EXPECT_EQ(metadataObj.getIconURL(), "");
    EXPECT_EQ(metadataObj.getIconImageType(), "");
    EXPECT_EQ(metadataObj.getTotalSupply(), BFXTInt("1000000"));
...
TEST(bfxt_tests, bfxt_metadata_parsing_2)
{
    const std::string tx_hex =
    ...
    EXPECT_EQ(
        ...
        "https://bfxt-icons.ams3.digitaloceanspaces.com/50aa59a0cecaed91b9e1fce937f14f363b2d222b.png");
    EXPECT_EQ(metadataObj.getIconImageType(), "image/png");
    EXPECT_EQ(metadataObj.getTotalSupply(), BFXTInt("100000000"));
    EXPECT_EQ(metadataObj.getDivisibility(), 7);
    EXPECT_EQ(metadataObj.getLockStatus(), true);
    EXPECT_EQ(metadataObj.getAggregationPolicy(), "aggregatable");
    EXPECT_EQ(metadataObj.getIssuanceTxId(), tx.GetHash());
...
TEST(bfxt_tests, bfxt_metadata_parsing_3)
{
    const std::string tx_hex =
    ...
    EXPECT_EQ(metadataObj.getTokenDescription(), "BFXT Version3");
    EXPECT_EQ(metadataObj.getTokenIssuer(), "bfxcrypto");
    EXPECT_EQ(
        metadataObj.getIconURL(),
        "https://bfxt-icons.ams3.digitaloceanspaces.com/0a0245f28b8ea8571a8165e37dc16e006426c4eb.png");
    EXPECT_EQ(metadataObj.getIconImageType(), "image/png");
    EXPECT_EQ(metadataObj.getTotalSupply(), BFXTInt("999998"));
    EXPECT_EQ(metadataObj.getDivisibility(), 7);
    EXPECT_EQ(metadataObj.getLockStatus(), true);
    EXPECT_EQ(metadataObj.getAggregationPolicy(), "aggregatable");
    EXPECT_EQ(metadataObj.getIssuanceTxId(), tx.GetHash());
...
TEST(bfxt_tests, bfxt_metadata_parsing_4)
{
    const std::string tx_hex =
    ...
    EXPECT_EQ(
        metadataObj.getIconURL(),
        "https://bfxt-icons.ams3.digitaloceanspaces.com/a5709018231ada78143bd609f30633db7f81d0a4.png");
    EXPECT_EQ(metadataObj.getIconImageType(), "image/png");
    EXPECT_EQ(metadataObj.getTotalSupply(), BFXTInt("100000000"));
    EXPECT_EQ(metadataObj.getDivisibility(), 7);
    EXPECT_EQ(metadataObj.getLockStatus(), true);
...
TEST(bfxt_tests, bfxt_metadata_parsing_5)
{
    const std::string tx_hex =
    ...
    EXPECT_EQ(
        metadataObj.getIconURL(),
        "https://bfxt-icons.ams3.digitaloceanspaces.com/176c4dba9a03a235d0eb54e5b66e79af97592bb6.png");
    EXPECT_EQ(metadataObj.getIconImageType(), "image/png");
    EXPECT_EQ(metadataObj.getTotalSupply(), BFXTInt("1000000000"));
    EXPECT_EQ(metadataObj.getDivisibility(), 7);
    EXPECT_EQ(metadataObj.getLockStatus(), true);
    EXPECT_EQ(metadataObj.getAggregationPolicy(), "aggregatable");
    EXPECT_EQ(metadataObj.getIssuanceTxId(), tx.GetHash());
...
TEST(bfxt_tests, bfxt_metadata_parsing_6)
{
    const std::string tx_hex =
...
TEST(bfxt_tests, bfxt_metadata_parsing_7)
{
    const std::string tx_hex =
    ...
    EXPECT_EQ(
        metadataObj.getIconURL(),
        "https://bfxt-icons.ams3.digitaloceanspaces.com/76bfced9e14befeb170bff5876d56e6aa7616349.gif");
...
TEST(bfxt_tests, bfxt_metadata_parsing_8)
{
    const std::string tx_hex =
    ...
    EXPECT_EQ(
        metadataObj.getIconURL(),
        "https://bfxt-icons.ams3.digitaloceanspaces.com/8dde92ea5fab1b98f793b67b7b0b2345230719a0.png");
    EXPECT_EQ(metadataObj.getIconImageType(), "image/png");
    EXPECT_EQ(metadataObj.getTotalSupply(), BFXTInt("1000000000"));
    EXPECT_EQ(metadataObj.getDivisibility(), 7);
    EXPECT_EQ(metadataObj.getLockStatus(), true);
...
// TEST(bfxt_tests, total_fee_calculator)
//{
//    std::string txStr =
...
// TEST(bfxt_tests, tmp)
//{
//    TestBFXTTxParsing("0a71b6db7994cc91d7e24302428e44dc0871eff23caddfd75099e76666374175", false);
//}

// TEST(bfxt_tests, tmp2)
//{
//    std::shared_ptr<BFXTScript> script =
//        BFXTScript::ParseScript("4e54040164697634302018010120189000000053789cab564a492c4954b2aa562ac9cf4"
