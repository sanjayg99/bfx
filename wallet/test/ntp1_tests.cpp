...
std::string NTP1Tests_GetRawBFXTxsFileName(bool testnet)
{
    if (!testnet) {
        return "txs_ntp1tests_raw_bfx_txs.json";
    } else {
        return "txs_ntp1tests_raw_bfx_txs_testnet.json";
    }
}
...
void TestNTP1TxParsingLocally(bool testnet)
{
    ...
    {
        json_spirit::Object nebltxs = read_json_obj(NTP1Tests_GetRawBFXTxsFileName(testnet));
...
void DownloadData(bool testnet)
{
    ...
    std::string f1 = NTP1Tests_GetRawBFXTxsFileName(testnet);
...
void DownloadPreMadeData(bool testnet)
{
    ...
    files.push_back(NTP1Tests_GetRawBFXTxsFileName(testnet));
