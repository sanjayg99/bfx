...
BFX_TEST += TRUE
BFX_ROOT = $${PWD}/../..
TEST_ROOT = $${BFX_ROOT}/wallet/test/
DEFINES += "TEST_ROOT_PATH=\"\\\"$${TEST_ROOT}\\\"\""
VPATH       += $${BFX_ROOT}/wallet $${BFX_ROOT}/wallet/json $${BFX_ROOT}/wallet/qt
INCLUDEPATH += $${BFX_ROOT}/wallet $${BFX_ROOT}/wallet/json $${BFX_ROOT}/wallet/qt
...
include($${BFX_ROOT}/wallet/wallet.pri)
include($${BFX_ROOT}/wallet/wallet-libs.pri)
