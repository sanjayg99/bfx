...
const string strMessageMagic = "BFX Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (nBestHeight == 0) {
        // Total premine coin, after the first 501 blocks are mined there will be a total of 150,000,000
        nSubsidy = 149000000 * COIN;
    }
...
bool CheckDiskSpace(std::uintmax_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes) {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bfx",
...

{
    ...
    if (mapBlockIndex.empty()) {
        ...
        const char*  pszTimestamp = "21jul2017 - BFX First Net Launches";
        CTransaction txNew;
