...
public:
    ...
    void retranslateUi(QDialog* OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate(
            "OptionsDialog", "Automatically start bfx after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(
            QApplication::translate("OptionsDialog", "&Start bfx on system login", Q_NULLPTR));
        ...
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog",
                                                        "Automatically open the bfx client port on "
        ...
        connectSocks->setToolTip(QApplication::translate(
            "OptionsDialog",
            "Connect to the bfx network through a SOCKS proxy (e.g. when connecting through Tor).",
            Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        lang->setToolTip(QApplication::translate("OptionsDialog",
                                                 ...
                                                 "setting will take effect after restarting bfx.",
                                                 Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        unitLabel->setText(
        ...
        displayAddresses->setToolTip(QApplication::translate(
            "OptionsDialog", "Whether to show bfx addresses in the transaction list or not.",
            Q_NULLPTR));
#endif // QT_NO_TOOLTIP
