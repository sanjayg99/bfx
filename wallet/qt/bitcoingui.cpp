...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About bfx"), this);
    aboutAction->setToolTip(tr("Show information about bfx"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for bfx"));
...
#endif
            if (trayIcon) {
                trayIcon->setToolTip(tr("bfx client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("bfx client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to bfx network", "", count));
}
    ...
    if (event->mimeData()->hasUrls()) {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"),
                                tr("URI can not be parsed! This can be caused by an invalid bfx "
...
void BitcoinGUI::handleURI(QString strURI)
{
    ...
    if (sendCoinsPage->handleURI(strURI)) {
        ...
        notificator->notify(Notificator::Warning, tr("URI handling"),
                            tr("URI can not be parsed! This can be caused by an invalid bfx address "
...
void BitcoinGUI::backupWallet()
{
    ...
    if (pwalletMain->IsLocked()) {
        ...
        answer = QMessageBox::question(
            ...
            tr("Unlocking your wallet will help BFX Wallet notify you when the next backup is "
...
void BitcoinGUI::checkForBFXUpdates()
{
    if (!isUpdateRunning && appInitiated) {
        ...
        boost::thread updaterThread(boost::bind(&BFXUpdater::checkIfUpdateIsAvailable, &bfxUpdater,
...
void BitcoinGUI::finishCheckForBFXUpdates()
{
        ...
        try {
            ...
            if (updateAvailable) {
                ...
                disconnect(updaterLabel, &ClickableLabel::clicked, this,
                           &BitcoinGUI::checkForBFXUpdates);
                connect(updaterLabel, &ClickableLabel::clicked, updateDialog, &BFXUpdateDialog::show);
...
void BitcoinGUI::setupUpdateControls()
{
    ...
    updateDialog = new BFXUpdateDialog(this);

    connect(updaterCheckMovie, &QMovie::frameChanged, this,
            &BitcoinGUI::updateCheckAnimation_frameChanged);

    connect(updaterLabel, &ClickableLabel::clicked, this, &BitcoinGUI::checkForBFXUpdates);

    connect(updateConcluderTimer, &QTimer::timeout, this, &BitcoinGUI::finishCheckForBFXUpdates);

    connect(updateCheckTimer, &QTimer::timeout, this, &BitcoinGUI::checkForBFXUpdates);
