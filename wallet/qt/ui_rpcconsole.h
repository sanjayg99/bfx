...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "bfx - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "bfx Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the bfx debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
        openDataDirButton->setToolTip(QApplication::translate("RPCConsole", "Show the data directory of BFX, that includes the blockchain, the wallet and configuration files, the logs and more.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
