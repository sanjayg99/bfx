...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About bfx", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>bfx</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017-2019 The BFX developers", Q_NULLPTR));
