#ifndef BFXTCUSTOMMETADATAWIDGET_H
#define BFXTCUSTOMMETADATAWIDGET_H
...
class BFXTCustomMetadataWidget : public QWidget
{
    Q_OBJECT
...
public:
    BFXTCustomMetadataWidget(QWidget* parent = Q_NULLPTR);
...
#endif // BFXTCUSTOMMETADATAWIDGET_H
