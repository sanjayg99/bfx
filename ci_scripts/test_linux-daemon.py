...
nci.call_with_err_code('strip ./bfxd')

file_name = '$(date +%Y-%m-%d)---' + os.environ['BRANCH'] + '-' + os.environ['COMMIT'][:7] + '---bfxd---ubuntu16.04.tar.gz'

nci.call_with_err_code('tar -zcvf "' + file_name + '" ./bfxd')
