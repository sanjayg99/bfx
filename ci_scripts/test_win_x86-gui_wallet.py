...
os.chdir(build_dir)
nci.call_with_err_code('i686-w64-mingw32.static-qmake-qt5 "QMAKE_CXX=ccache i686-w64-mingw32.static-g++" "USE_UPNP=1" "USE_QRCODE=1" "RELEASE=1" ../bfx-wallet.pro')
nci.call_with_err_code("make -j" + str(mp.cpu_count()))

file_name = '$(date +%Y-%m-%d)---' + os.environ['BRANCH'] + '-' + os.environ['COMMIT'][:7] + '---BFX-Qt---windows_x86.zip'
