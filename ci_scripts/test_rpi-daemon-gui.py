...
if (os.environ.get('TRAVIS_BUILD_DIR') is not None):
  ...
  nci.call_with_err_code('sudo docker run -e BRANCH=' + os.environ['BRANCH'] + ' -e BUILD=' + build_target + ' -v ' + os.environ['BUILD_DIR'] + ':/root/vol -t bfxteam/bfxd-build-ccache-rpi')
